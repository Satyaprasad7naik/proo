...
const FlavorSection = () => {
    ...
    useGSAP(() => {
        ...
        const scrollInner = document.querySelector(".flavor-scroll-inner");
        if (!scrollInner) return;

        const scrollAmount = scrollInner.scrollWidth - window.innerWidth;
    ...
    return (
        <section ref={flavorRef} className="flavor-section relative overflow-hidden">
            ...
            <div className="flavor-scroll-inner h-full flex lg:flex-row flex-col relative lg:w-[max-content]">
