...
const FooterSection = () => {
    ...
    return (
        <section className="footer-section lg:pt-20 relative w-full overflow-hidden">
            ...
            </div>
            {
                isMobF ?
                    ...
                    :
                    <video ref={vidRef} src={splash} playsInline muted preload="metadata" className="absolute object-contain top-[-4%] mix-blend-lighten z-10 opacity-90" />
            }
